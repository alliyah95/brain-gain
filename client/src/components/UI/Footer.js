...
const Footer = () => {
    return (
        <footer className="mt-16 md:mt-20 py-8 px-5 xl:px-8 bg-brown-darker text-light-brown ">
            <div className="flex flex-col md:flex-row items-center md:justify-between md:w-[90%] md:mx-auto">
